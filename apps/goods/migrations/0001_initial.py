# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2018-09-06 22:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('desc', models.CharField(default='', help_text='类别描述', max_length=20, verbose_name='类别描述')),
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
                ('category_category', models.ForeignKey(blank=True, max_length=20, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sub_cat', to='goods.GoodsCategory', verbose_name='父类级别')),
            ],
            options={
                'verbose_name': '商品类别',
        ...
        migrations.AddField(
            model_name='goods',
            name='category',
            field=models.ForeignKey(blank=True, help_text='商品类别', null=True, on_delete=django.db.models.deletion.CASCADE, to='goods.GoodsCategory', verbose_name='商品类目'),
        ),
        migrations.AddField(
            model_name='banner',
            name='goods',
